                ...
                <div class="">
                    ...
                    <form action="{{ route('ads.messages.store', $ad) }}" method="POST">
                        ...
                        <textarea name="content" required
                            class="w-full h-40 p-4 text-lg border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#00A9A3] focus:border-transparent placeholder-gray-400"
                            placeholder="Typ hier je bericht..."></textarea>
                        @auth <button type="submit"
                                class="bg-[#00A9A3] hover:bg-[#019A95] text-white border-2 px-4 py-2 rounded">Verstuur
                                bericht</button>
                        @endauth
